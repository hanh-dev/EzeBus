    ...
    <div class="home-container">
        ...
        <div class="home">
                ...
                <div class="route-container">
                    ...
                    <div class="route-list">
                        <div class="route-card">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="HCM - Quảng Trị">
                        ...
                        <div class="route-card">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Quảng Trị - Bình Dương">
                            <div class="route-info">
                        ...
                        <div class="route-card">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Quảng Trị - Đà Lạt">
                            <div class="route-info">
                        ...
                        <div class="route-card">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Đà Lạt - Hồ Chí Minh">
                            <div class="route-info">
                ...
                <div class="extention-container">
                    ...
                    <div class="features">
                        <div class="feature">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Tiện ích cao cấp">
                        ...
                        <div class="feature">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Đáp ứng mọi khung giờ">
                            <div class="feature-content">
                        ...
                        <div class="feature">
                            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Dịch vụ đẳng cấp">
                            <div class="feature-content">
...
>>>>>>> 494be921b41a64bac83124bbe29ac3d235d1605d
