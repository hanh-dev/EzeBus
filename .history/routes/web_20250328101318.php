...
Route::get('/blog/author/{author}', [PageController::class, 'blogAuthor'])->name('blog.author');
Route::get('/blog/comments', [PageController::class, 'blogComments'])->name('blog.comments');
