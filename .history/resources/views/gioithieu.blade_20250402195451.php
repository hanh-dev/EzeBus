    ...
    <section class="intro">
        ...
        <div class="intro-content">
            <div class="intro-text">
                ...
                <p>EzeBus là một trong những công ty hàng đầu trong ngành vận tải hành khách, chuyên cung cấp các dịch vụ xe khách chất lượng cao, an toàn và tiện nghi. Với đội ngũ lái xe chuyên nghiệp và các phương tiện hiện đại, chúng tôi cam kết mang đến cho khách hàng những chuyến đi thoải mái và an tâm nhất.
Chúng tôi luôn nỗ lực cải thiện và nâng cao chất lượng dịch vụ, từ việc đảm bảo an toàn trên mỗi chuyến đi đến việc tối ưu hóa trải nghiệm khách hàng với các dịch vụ linh hoạt và tiện ích như wifi miễn phí, ghế ngồi thoải mái, và không gian sạch sẽ, rộng rãi. EzeBus luôn đặt sự hài lòng của khách hàng lên hàng đầu, đồng thời cam kết duy trì một môi trường vận hành thân thiện với môi trường.</p>
            </div>
