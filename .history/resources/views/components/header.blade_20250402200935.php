<header>
    ...
    <li><a href="{{ url('/gioi-thieu') }}" class="nav-link">Giới thiệu</a></li>
    <li><a href="{{ url('/dich-vu') }}" class="nav-link">Dịch vụ</a></li>
    <li><a href="{{ url('/tin-tuc') }}" class="nav-link">Tin tức</a></li>
    <li><a href="{{ url('/lien-he') }}" class="nav-link">Liên hệ</a></li>
</ul>
