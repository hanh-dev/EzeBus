    ...
    <section class="intro">
        ...
        <div class="intro-content">
            ...
            <div class="intro-media">
                <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Giới thiệu">
...
<section class="vision-mission">
    <div class="vision">
        {{-- <div class="icon">
            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Tầm Nhìn">
        </div> --}}
        <h3>TẦM NHÌN</h3>
        <p>EzeBus hướng tới trở thành công ty vận tải hành khách hàng đầu tại Việt Nam và khu vực, mang đến những chuyến đi an toàn, tiện nghi và thân thiện với môi trường. Chúng tôi phấn đấu xây dựng một hệ thống giao thông hiện đại, thông minh, kết nối mọi miền đất nước, phục vụ nhu cầu di chuyển ngày càng cao của khách hàng, đồng thời góp phần thúc đẩy sự phát triển bền vững của ngành vận tải.</p>
    </div>
    <div class="mission">
        {{-- <div class="icon">
            <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Sứ Mệnh">
        </div> --}}
        <h3>SỨ MỆNH</h3>
        <p>Sứ mệnh của EzeBus là cung cấp dịch vụ vận tải hành khách chất lượng cao, an toàn và tiện lợi, với mục tiêu đem lại trải nghiệm tuyệt vời cho mọi hành khách. Chúng tôi cam kết không ngừng cải tiến chất lượng dịch vụ, đầu tư vào đội xe hiện đại và đội ngũ nhân viên chuyên nghiệp, nhằm mang đến sự hài lòng tối đa cho khách hàng. EzeBus luôn đặt sự an toàn, sự thoải mái và tiện ích của hành khách lên hàng đầu, đồng thời nỗ lực góp phần bảo vệ môi trường và phát triển cộng đồng.

</p>
    </div>
    <div class="image">
        <img src="{{ asset('images\IMG_9357.JPG') }}" alt="Tầm Nhìn - Sứ Mệnh">
    </div>
</section>
